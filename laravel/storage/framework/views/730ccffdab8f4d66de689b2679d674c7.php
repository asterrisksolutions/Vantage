...
<body>
  <header class="top-bar">
    <h1>VANTAGE</h1>
    <div class="user-info">
      <a href="<?php echo e(route('user.profile')); ?>" class="user-name-link">John Doe</a>
...
</html><?php /**PATH C:\Users\Velasco Ralph\OneDrive\Desktop\Vantage-Demo1 - Copy (2)\resources\views/user/landing.blade.php ENDPATH**/ ?>