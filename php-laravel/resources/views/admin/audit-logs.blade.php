...
<head>
    ...
    <title>Audit Logs - VANTAGE</title>
    ...
    <div class="main-container">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li onclick="window.location='{{ route('admin.audit-logs') }}'" style="background: rgba(124, 58, 237, 0.2); color: #a78bfa;">Audit Logs</li>
        ...
        <div class="main-content">
            <div class="page-header">
                <h1>Audit Logs</h1>
                <p>View security-related events and activities.</p>
            </div>

            <div class="card">
                <h2>Recent Events</h2>
                <p style="color: #94a3b8;">Audit log functionality coming soon.</p>
            </div>
        </div>
    </div>
</body>
